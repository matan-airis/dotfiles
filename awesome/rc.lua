...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, ";", function () awful.spawn.with_shell("maim -s | xclip -selection clipboard -t image/png") end,
...
awful.spawn.with_shell("setxkbmap -layout us,il -option grp:alt_space_toggle")
awful.spawn.with_shell("inputplug -c .local/bin/inputplug-script")
